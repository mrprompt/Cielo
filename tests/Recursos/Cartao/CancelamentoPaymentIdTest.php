...
class CancelamentoPaymentIdTest extends TestCase
{
    #[Test]
    #[TestDox('Testa a invocação do método Cancelamento por PaymentId')]
    ...
    public function testInvoke(string $id, int $valor, string $expectedUrl): void
    {
        ...
        $cancelamento = new CancelamentoPaymentId($httpDriver);
