...
class IdentificacaoTransacaoTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @covers IdentificacaoTransacao::getXmlInicial()
    ...
    /**
     * @test
     * @covers IdentificacaoTransacao::configuraEnvio()
    ...
    /**
     * @test
     * @covers IdentificacaoTransacao::deveAdicionarTid()
    ...
    /**
     * @test
     * @covers IdentificacaoTransacao::adicionaFormaPagamento()
