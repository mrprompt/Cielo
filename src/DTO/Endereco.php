...
class Endereco implements Dto
{
    ...
    public static function fromRequest(object $request, TipoEndereco $tipo = TipoEndereco::PRINCIPAL): static
    {
        return new self(
            tipo: $tipo,
    ...
    public static function fromArray(array $data, TipoEndereco $tipo = TipoEndereco::PRINCIPAL): static
    {
        return new self(
            tipo: $tipo,
